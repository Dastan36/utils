				...
				$(".mouse-right-menu .enian_menu .text").click(function() {
					if (callback) {
						...
						if ($(this).children('a').data('type') == 1) {
							returnData.data = JSON.parse($(this)
									.children('a').html())
						} else {
							returnData.data = $(this).children('a')
									.html();
						}
