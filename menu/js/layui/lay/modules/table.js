 ...
 layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
 	...
 	I.prototype.config = {
 		...
 		var e, t = this,
 			i = t.config,
 			a = i.height;
 		t.fullHeightGap && (a = R.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", a)), a && (e = parseFloat(a) - (t.layHeader.outerHeight() || 38), i.toolbar && (e -= t.layTool.outerHeight() || 50), i.totalRow && (e -= t.layTotal.outerHeight() || 40), i.page && (e -= t.layPage.outerHeight() || 41), t.layMain.css("height", typeof isFF == 'function' && isFF() ? e + 8 : e - 2))
 	...
 	}, d.resetHeight = function(e, h) { // 表格重新设置高度 table.resetHeight(tableId, 'full-100')
 		var i = s(e);
 		if (i) {
 			var a = c.that[e],
 				i = a.config;
 			a.fullHeightGap = h.split("-")[1], i.height = R.height() - a.fullHeightGap
 			return a.resize()
 		}
 	}, d.init(), e(y, d)
 });